                ...
                <CardHeader className="pb-2">
                    <div className="flex items-start justify-between">
                        <div>
                            ...
                            <CardDescription>
                                Проверено {reviewItem.date} •{" "}
                                {reviewItem.wordCount} слов
                            </CardDescription>
                        </div>
                    ...
                    <div className="grid gap-6 md:grid-cols-3">
                        <div className="space-y-2">
                            <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center">
                                    {reviewItem.similarity > 20 ? (
                                        <AlertCircle className="mr-1 h-4 w-4 text-destructive" />
                                    ) : (
                                        <CheckCircle className="mr-1 h-4 w-4 text-primary" />
                                    )}
                                    <span className="font-bold">
                                        {reviewItem.similarity}%
                                    </span>
                                </div>
                            </div>
                            <Progress
                                value={reviewItem.similarity}
                                className="h-2"
                            />
                            <p className="text-xs text-muted-foreground">
                                {reviewItem.similarity < 15
                                    ? "Низкий уровень совпадений. Ваш текст в основном оригинален."
                                    : reviewItem.similarity < 30
                                      ? "Средний уровень совпадений. Некоторые фрагменты могут требовать доработки."
                                      : "Высокий уровень совпадений. Рекомендуется значительная переработка."}
                            </p>
                        </div>
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center justify-between">
                                ...
                                <span className="font-bold">
                                    {reviewItem.uniqueness}%
                                </span>
                            </div>
                            <Progress
                                value={reviewItem.uniqueness}
                                className="h-2"
                            />
                            <p className="text-xs text-muted-foreground">
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center">
                                    ...
                                    <span className="font-bold">
                                        {reviewItem.aiContent}%
                                    </span>
                                </div>
                            </div>
                            <Progress
                                value={reviewItem.aiContent}
                                className="h-2"
                            />
                            <p className="text-xs text-muted-foreground">
